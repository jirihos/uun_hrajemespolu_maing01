...
describe(`UunHrajemeSpolu.Bricks.Reviews.ReviewProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<UunHrajemeSpolu.Bricks.Reviews.ReviewProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
