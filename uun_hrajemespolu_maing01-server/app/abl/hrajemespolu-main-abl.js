...
const Errors = require("../api/errors/hrajemespolu-main-error.js");
...
const logger = LoggerFactory.get("HrajemespoluMainAbl");

class HrajemespoluMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["hrajemespoluMain", "sportsField", "reservation", "gallery", "review"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UunHrajemespolu",
        typeCode: "uun-hrajemespolu-maing01",
        location: location,
...
module.exports = new HrajemespoluMainAbl();
